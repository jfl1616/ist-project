...
IST-Project is a client side project based on HTML/AJAX site by using jQuery to pull the API root nodes that contain the JSON objects.

## Live-preview web pages
